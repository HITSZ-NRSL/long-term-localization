...
class LaserScan:
  ...
  def __init__(self, project=False, H=80, W=1024, fov_up=3.0, fov_down=-25.0):
  ...
  def open_scan(self, filename):
    ...
    rings = 80-1-scan[:, 4].astype(np.int32)  # get rings
    self.set_points(points, rings, remissions) #remissions

  def set_points(self, points, rings, remissions=None):
    ...
    if self.project:
      self.do_range_projection(rings)

  def do_range_projection(self, rings):
